...
- **granularity**: Sets the AWS cost granularity to `"MONTHLY"` or `"DAILY"`. If Granularity isn't set, the response object doesn't include the Granularity, either `"MONTHLY"` or `"DAILY"`. (string, optional)
