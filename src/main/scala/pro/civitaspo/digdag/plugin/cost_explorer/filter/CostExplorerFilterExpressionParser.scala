...
class CostExplorerFilterExpressionParser(tagValuesGetter: TagValuesGetter, dimensionValuesGetter: DimensionValuesGetter) {
  ...
  private class CostExplorerFilterExpressionVisitor(ceExpr: costexplorer.model.Expression = new costexplorer.model.Expression)
    ...
    override def visit(function: expression.Function): Unit = throw new UnsupportedOperationException
    override def visit(expr: SignedExpression): Unit = throw new UnsupportedOperationException
    override def visit(parameter: JdbcParameter): Unit = throw new UnsupportedOperationException
    override def visit(parameter: JdbcNamedParameter): Unit = throw new UnsupportedOperationException
    override def visit(value: DoubleValue): Unit = throw new UnsupportedOperationException
    override def visit(value: LongValue): Unit = throw new UnsupportedOperationException
    override def visit(value: DateValue): Unit = throw new UnsupportedOperationException
    override def visit(value: TimeValue): Unit = throw new UnsupportedOperationException
    override def visit(value: TimestampValue): Unit = throw new UnsupportedOperationException
    override def visit(value: StringValue): Unit = throw new UnsupportedOperationException
    override def visit(expr: Addition): Unit = throw new UnsupportedOperationException
    override def visit(expr: Division): Unit = throw new UnsupportedOperationException
    override def visit(expr: Multiplication): Unit = throw new UnsupportedOperationException
    override def visit(expr: Subtraction): Unit = throw new UnsupportedOperationException
    override def visit(expr: Between): Unit = throw new UnsupportedOperationException
    override def visit(expr: GreaterThan): Unit = throw new UnsupportedOperationException
    override def visit(expr: GreaterThanEquals): Unit = throw new UnsupportedOperationException
    ...
    override def visit(expr: ExistsExpression): Unit = throw new UnsupportedOperationException
    override def visit(expr: AllComparisonExpression): Unit = throw new UnsupportedOperationException
    override def visit(expr: AnyComparisonExpression): Unit = throw new UnsupportedOperationException
    override def visit(expr: Concat): Unit = throw new UnsupportedOperationException
    override def visit(expr: Matches): Unit = throw new UnsupportedOperationException
    override def visit(expr: BitwiseAnd): Unit = throw new UnsupportedOperationException
    override def visit(expr: BitwiseOr): Unit = throw new UnsupportedOperationException
    override def visit(expr: BitwiseXor): Unit = throw new UnsupportedOperationException
    override def visit(expr: CastExpression): Unit = throw new UnsupportedOperationException
    override def visit(expr: Modulo): Unit = throw new UnsupportedOperationException
    override def visit(expr: AnalyticExpression): Unit = throw new UnsupportedOperationException
    override def visit(expr: ExtractExpression): Unit = throw new UnsupportedOperationException
    override def visit(expr: IntervalExpression): Unit = throw new UnsupportedOperationException
    override def visit(expr: OracleHierarchicalExpression): Unit = throw new UnsupportedOperationException
    override def visit(expr: RegExpMatchOperator): Unit = throw new UnsupportedOperationException
    override def visit(expressionList: ExpressionList): Unit = throw new UnsupportedOperationException
    override def visit(multiExprList: MultiExpressionList): Unit = throw new UnsupportedOperationException
    override def visit(notExpr: NotExpression): Unit = throw new UnsupportedOperationException
    override def visit(expr: BitwiseRightShift): Unit = throw new UnsupportedOperationException
    override def visit(expr: BitwiseLeftShift): Unit = throw new UnsupportedOperationException
    override def visit(jsonExpr: JsonExpression): Unit = throw new UnsupportedOperationException
    override def visit(expr: JsonOperator): Unit = throw new UnsupportedOperationException
    override def visit(expr: RegExpMySQLOperator): Unit = throw new UnsupportedOperationException
    override def visit(`var`: UserVariable): Unit = throw new UnsupportedOperationException
    override def visit(bind: NumericBind): Unit = throw new UnsupportedOperationException
    override def visit(expr: KeepExpression): Unit = throw new UnsupportedOperationException
    override def visit(groupConcat: MySQLGroupConcat): Unit = throw new UnsupportedOperationException
    override def visit(valueListExpression: ValueListExpression): Unit = throw new UnsupportedOperationException
    override def visit(pivot: Pivot): Unit = throw new UnsupportedOperationException
    override def visit(pivot: PivotXml): Unit = throw new UnsupportedOperationException
    override def visit(allColumns: AllColumns): Unit = throw new UnsupportedOperationException
    override def visit(allTableColumns: AllTableColumns): Unit = throw new UnsupportedOperationException
    override def visit(selectExpressionItem: SelectExpressionItem): Unit = throw new UnsupportedOperationException
    override def visit(rowConstructor: RowConstructor): Unit = throw new UnsupportedOperationException
    override def visit(hexValue: HexValue): Unit = throw new UnsupportedOperationException
    override def visit(hint: OracleHint): Unit = throw new UnsupportedOperationException
    override def visit(timeKeyExpression: TimeKeyExpression): Unit = throw new UnsupportedOperationException
    override def visit(literal: DateTimeLiteralExpression): Unit = throw new UnsupportedOperationException
  }
}
